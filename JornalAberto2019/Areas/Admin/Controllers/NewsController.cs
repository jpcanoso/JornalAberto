...
namespace JornalAberto2019.Areas.Admin.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NoticiaID,DataNoticia,Titulo,Descricao,Corpo")] Noticias noticia, string[] selectedCategories, IEnumerable<HttpPostedFileBase> files)
        {
            if (ModelState.IsValid)
            {
                ...
                foreach (HttpPostedFileBase file in files)
                {
                    ...
                    if (file != null)
                    {
                        ...
                        Imagem ficheiro = new Imagem()
                        {
                            Descricao = "a",
                            Path = InputFileName
                        };
                        imagens.Add(ficheiro);
                    }
                }
        ...
        // verificar se o ficheiro e imagem
